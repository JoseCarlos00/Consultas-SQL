SELECT 
  PRINCIPAL.WORK_ZONE,PRINCIPAL.LOCATION,PRINCIPAL.ITEM,PRINCIPAL.DESCRIPTION, CAST(SUM(PRINCIPAL.OH) AS INT) AS OH, CAJAS, PICKING
...
GROUP BY PRINCIPAL.WORK_ZONE,PRINCIPAL.LOCATION,PRINCIPAL.ITEM,PRINCIPAL.DESCRIPTION, CAJAS, PICKING

-- WORK_ZONE,LOCATION,ITEM,DESCRIPTION,OH,CAJAS,PICKING,
