SELECT 
  PRINCIPAL.WORK_ZONE,PRINCIPAL.LOCATION,PRINCIPAL.ITEM,PRINCIPAL.DESCRIPTION, CAST(SUM(PRINCIPAL.OH) AS INT) AS OH, CAJAS
...
GROUP BY PRINCIPAL.WORK_ZONE,PRINCIPAL.LOCATION,PRINCIPAL.ITEM,PRINCIPAL.DESCRIPTION, CAJAS
