...
FROM (
    SELECT
        ...
        CASE
            ...
            THEN '1ER PISO'
            WHEN TH.WORK_ZONE IN 
                ('W-Mar Bodega 10', 'W-Mar Bodega 11', 'W-Mar Bodega 12', 'W-Mar Bodega 13', 'W-Mar Bodega 14', 'W-Mar Bodega 15', 'W-Mar Bodega 16', 'W-Mar Bodega 17', 'W-Mar No Banda', 'W-Mar Bodega 20', 'W-Mar Bodega 21', 'W-Mar Segundo Piso Reserv', 'W-Mar Segundo Piso')
            THEN '2DO PISO'
            ELSE TH.WORK_ZONE
        END AS ZONA,
