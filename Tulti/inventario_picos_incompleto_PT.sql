SELECT  
  ...
  CAST(HUELLA_CJ AS INT) AS HUELLA_CJ,
  CAJAS,
  GRUPO
...
FROM (
    ...
    AND I.item_category4 <> 'ZMUEBLE TDAS'
...
-- @headers: WAREHOUSE, WORk_ZONE, LOCATION, ITEM, ITEM_COLOR, COMPANY, AV, OH, AL, IT, SU, HUELLA, CAJAS, GRUPO, 
