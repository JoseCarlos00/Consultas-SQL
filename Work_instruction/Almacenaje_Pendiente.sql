SELECT
  ...
  CAST(SUM(PRINCIPAL.CANTIDAD) / PRINCIPAL.HUELLA AS DECIMAL(5, 2)) AS CAJAS, -- CAST((LI.on_hand_qty / UOM.conversion_qty) AS DECIMAL(5, 2)) AS CAJAS,
  PRINCIPAL.COMPANY,
...
ORDER BY 8 ASC, DATE_RECEIPT ASC
