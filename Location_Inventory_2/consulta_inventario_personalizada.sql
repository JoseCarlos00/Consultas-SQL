...
AND L.location_type LIKE 'Gene%'
AND L.work_zone = 'W-Mar Bodega 2'
-- AND L.location LIKE '1%'
-- AND L.location >= '1-90-01%' AND L.location <= '1-90-05%'
--AND item IN ( )

ORDER BY L.WORK_ZONE, LI.LOCATION, LI.ITEM

-- @headers: WORK_ZONE,LOCATION,ITEM,DESCRIPTION,COMPANY,AV,OH, AL, IT, SU, LICENSE_PLATE,
